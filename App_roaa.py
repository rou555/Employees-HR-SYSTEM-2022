...
# fix adding employee window (page 1" newemployee" //page 2"newemployee 2" )
    # next button , back button , save button ,...

# fix edit employee 
    # Hint see class Login to see how to do the serach in the Database 
    # another one see in add new employee @ the part of showing the company info in the ComboBox to display the fields of the employee you want to edit 
...
class WelcomeScreen(QDialog):
    ...
    def gotologin(self):
       ...
       # widget.setFixedHeight(660)
        #widget.setGeometry(50,50,100,600)
...
class MainWin(QDialog):
    def __init__(self):    
        ...
        self.employee_btn.clicked.connect(self.gotoemp)
        self.comp_btn.clicked.connect(self.gotoCompanyInfo)
        self.nuser_btn.clicked.connect(self.gotoAddUser)
        self.train_btn.clicked.connect(self.gotoTrain)
...
class NewEmployee(QDialog):
    ...
    def __init__(self):
        QWidget.__init__(self)
        widget.setGeometry(50,50,1300,1000)
...
class EditEmployee(QDialog): # ----need to add function delete
    def __init__(self):
        ...
        self.gates=self.ui.gateslist.selectedItems()
        self.getLISTit=[]
    ...
    def SearchEmpWithID(self):
        ...
        if (len(self.empid)==0):
            ...
            if result !=[]:
                ...
                #self.ui.gateslist.setCurrentItem(Gates_query_result_str)
...
class AddNewUser(QDialog):
    def __init__(self):
        ...
        self.cancel_btn.clicked.connect(self.goBack)
